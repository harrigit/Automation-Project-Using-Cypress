describe("Adepsi Logs", () => {
  it("Audit Trail", () => {
    ...
    cy.get(".p-calendar > .ng-tns-c108-4").click();

    cy.get(".p-datepicker-year").click();
    cy.get(".p-yearpicker > :nth-child(1)").click();
    cy.get('.p-monthpicker > [tabindex="0"]').click();
    cy.get('tbody.ng-tns-c108-4 > :nth-child(1) > :nth-child(4)').click();
    cy.wait(1000);
    cy.get('.p-calendar > .ng-tns-c108-5').click();
    cy.get(".p-datepicker-year").click();
    cy.get(".p-yearpicker > :nth-child(4)").click();
    cy.get('.p-monthpicker > :nth-child(5)').click();
    cy.get('tbody.ng-tns-c108-5 > :nth-child(1) > :nth-child(4) > .p-ripple').click();
    cy.get(".search-btn").click();
    cy.wait(3000);

    cy.get(':nth-child(1) > .dropFilters > .ng-tns-c119-3 > .wrapper > .mat-menu-trigger').click();
    cy.get('#mat-checkbox-1 > .mat-checkbox-layout > .mat-checkbox-inner-container').click();
    cy.get(':nth-child(2) > .dropFilters > .ng-tns-c119-3 > .wrapper > .mat-menu-trigger').click();
